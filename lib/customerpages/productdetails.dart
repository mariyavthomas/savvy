...
class Screenpdetails extends StatefulWidget {
  Screenpdetails({
    super.key, required this.imagePath,required this.productname,required this.price,required this.decripation});
          ...
          ListView(
            ...
            child: IconButton(
              ...
              const SizedBox(
               ...
               Center(child: Text('Decripation',style: TextStyle(fontWeight: FontWeight.w500),)),
               SizedBox(
                height: 19,
               ),
              Text(widget.decripation,
